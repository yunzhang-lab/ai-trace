...
1. 发起动作：H5 点击 "Scan" / 终端执行 `python3 skill/ai-trace/bin/main.py scan`。
...
1. 发起动作：H5 点击 "Register" 提交表单 / 终端执行 `python3 skill/ai-trace/bin/main.py register --candidate-id ...`。
2. 动作约束：
