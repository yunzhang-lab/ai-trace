...
const appTitles = {
  office: ["Home", "AI Trace", "扫描本机 Agent、声明空间契约、管理注册状态。"],
  spaces: ["Spaces", "空间契约层", "声明本机目录角色，供 AI Agent 协作参考。Phase 2 仅做浅层识别与归属提示。"],
  agents: ["Agents", "Agent 管理", "查看扫描候选、注册状态与 Agent Card 信息。注册操作写入 ~/.ai-trace/data/registry。"]
};
