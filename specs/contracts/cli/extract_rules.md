...
> format: 通用规则与工具方法
> parent_spec: [AGENT_DISCOVERY_SPEC.md](/specs/agents/AGENT_DISCOVERY_SPEC.md)
...
> 以上规则刻意保持**技术无关性**，适用于当前及未来新增的任何 Agent。各 Agent 特有的细节差异（如 SQLite Schema 区别等），请参阅 [PHYSICAL_STRUCTURES.md](/specs/agents/PHYSICAL_STRUCTURES.md) 中对应章节。
