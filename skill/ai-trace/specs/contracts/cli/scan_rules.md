...
为了让扫描脚本 [scan_agents.py](/Users/fengye/Projects/code/ai-trace-open/skill/ai-trace/bin/commands/scan_agents.py) 具备确定性的探测规则，本文件明确了系统当前支持的 AI Agent 列表、默认路径以及识别特征。
