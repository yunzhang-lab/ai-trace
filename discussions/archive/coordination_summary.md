...
> [!WARNING]
> 本文档为早期共识快照，部分内容（如目录结构、阶段精度）已被后续重构覆盖。
> 当前以 [README.md](/README.md)、[PROGRESS.md](/PROGRESS.md)、[ROADMAP.md](/phases/ROADMAP.md) 为准。
...
> [!WARNING]
> 以下为早期共识快照。当前公开仓已重构为 5 个核心顶级目录，以 [README.md](/README.md) 为准：
> `phases / drafts / discussions / agent_roots / skill`
